...
export default function Hero () {
    return (
        <>
        <div className="bg-[#E9C46A] h-auto grid grid-cols-1 md:grid-cols-2 p-10">
            <div className="">
                ...
                <p className="text-md text-black md:ms-20 mb-5">Sign Up and take a quick survey to receive personalized course recommendations and improve over time.</p>
                <button className="bg-[#E76F51] hover:bg-[#E76F51]/90 text-white py-2 px-4 rounded-full ms-20">
                {' '}
